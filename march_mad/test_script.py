...
def GPIndividual1(data):
    predictions = (np.sinh((((((np.tanh(data["team2Wmax"]) + ((data["team1Lstd"] + np.minimum( (data["team1losses"]),  (data["year"])))/2.0))/2.0)) + ((data["team2Seed"] == (1.0/(1.0 + np.exp(- data["team2wins"])))).astype(float)))/2.0)) +
                    ...
                    ((np.floor(np.minimum( (((1.73 == data["team1Lmax"]).astype(float))),  (np.cos(data["team1WAverage"])))) == ((np.round(((((-(data["team2LAverage"])) <= data["team2losses"]).astype(float)) - 2.21)) <= (data["team2Wmin"] * data["team2losses"])).astype(float))).astype(float)) +
                    ...
                    np.minimum( (((data["team2WAverage"] >= np.floor(data["team2Wmin"])).astype(float))),  (np.abs(((data["team1Seed"] >= np.sinh(((0.69 > np.minimum( (data["team2Wmedian"]),  (((data["team1Seed"] <= ((data["team1Wmedian"] <= np.cos(0.69)).astype(float))).astype(float))))).astype(float)))).astype(float))))) +
                    np.sin(np.sinh(((((-((((-(0.37)) <= data["team1Lmax"]).astype(float)))) + ((data["team1Wmin"] >= np.floor(data["team1Seed"])).astype(float)))/2.0) - ((np.sin(data["team2Wstd"]) > (data["team2Wmax"] + np.abs(data["team2"]))).astype(float))))) +
                    ...
                    np.maximum( (np.minimum( (data["team1Wmin"]),  (np.ceil(np.minimum( (np.minimum( (0.14),  (((data["team1Seed"] >= data["team2Lmedian"]).astype(float))))),  (data["team2losses"])))))),  ((((-(np.maximum( (data["team2"]),  (data["team2Seed"])))) > ((data["team1losses"] < 1.414214).astype(float))).astype(float)))) +
                    np.minimum( (np.maximum( (data["team1Lmin"]),  ((-(((data["team1wins"] >= np.cos(0.72)).astype(float))))))),  (np.minimum( (np.ceil((data["team1Wmedian"] / 2.0))),  ((-(((data["team1Wmin"] >= (1.197370 + ((data["team1Wstd"] < 0.09).astype(float)))).astype(float)))))))) +
                    ((((-(np.abs(np.abs(((data["team1"] + (-(0.14)))/2.0))))) * ((0.36 >= data["team2wins"]).astype(float))) > ((data["team1Wmedian"] + np.maximum( (data["team1"]),  (((0.37 != data["team1"]).astype(float)))))/2.0)).astype(float)) +
                    ...
                    np.minimum( (np.ceil(((data["team2Wmin"] + ((0.09 >= data["team2"]).astype(float)))/2.0))),  ((np.minimum( ((data["team1Lmax"] * data["team1Wmedian"])),  (((data["team1Wmedian"] < (data["team1Wmax"] - data["team2Lmedian"])).astype(float)))) * np.maximum( (data["team2Seed"]),  (data["team1Wmax"]))))) +
                    ((-(((data["team2Wmin"] >= ((-((data["team2Wstd"] + 0.32))) * (1.0/(1.0 + np.exp(- (-((1.0/(1.0 + np.exp(- 0.32)))))))))).astype(float)))) * (((1.0/(1.0 + np.exp(- data["year"]))) * data["team1Lmin"]) * data["team2Lstd"])) +
                    ...
                    np.ceil(((2.675680 <= np.abs(np.maximum( ((data["team2"] + np.maximum( (np.abs(data["team1Seed"])),  (data["team2LAverage"])))),  ((0.32 + (np.minimum( (data["team1Wmedian"]),  (((data["team2"] != data["team2LAverage"]).astype(float)))) - data["team2Lmin"])))))).astype(float))) +
                    ...
                    (((0.60 <= (data["team2Wmin"] - ((((np.cos(data["team1Wmedian"]) * 2.0) * 2.0) >= 1.650796).astype(float)))).astype(float)) * np.sin(np.sinh(np.sinh(data["team2Wstd"])))) +
                    (data["team1losses"] * ((data["team1Wmedian"] >= (np.tanh((((((-(data["team1Lmin"])) > 0.43).astype(float)) != ((np.minimum( (data["team1wins"]),  (((0.43 <= data["team2losses"]).astype(float)))) < data["team1Wmedian"]).astype(float))).astype(float))) * 2.0)).astype(float))) +
                    np.maximum( (((np.minimum( (data["team1Lmedian"]),  (((data["team2"] > np.maximum( (data["team2losses"]),  (0.59))).astype(float)))) >= (data["team1WAverage"] + ((1.414214 > data["team2Lmin"]).astype(float)))).astype(float))),  (((data["team2Wmin"] < (data["team1wins"] - 3.141593)).astype(float)))) +
                    np.round((np.round(((data["team2Lmedian"] * ((data["year"] > ((2.675680 + ((data["team1LAverage"] <= np.maximum( (data["team1WAverage"]),  (0.09))).astype(float)))/2.0)).astype(float))) * 2.0)) * 2.0)) +
                    ...
                    ((data["team2wins"] - np.sin(data["team2Wmin"])) * ((np.maximum( (data["team2wins"]),  (0.840000)) <= np.minimum( (data["team1Lmax"]),  ((np.maximum( (data["team2Wmax"]),  ((data["team2wins"] * np.floor(data["team2Wmax"])))) - 0.0588230)))).astype(float))) +
                    ...
                    ((data["team2Wmin"] > ((0.310310 + (((1.0/(1.0 + np.exp(- (((data["team2Seed"] * np.maximum( (data["team2"]),  (data["team1Lmax"]))) <= ((data["team2losses"] < data["team1Lmax"]).astype(float))).astype(float))))) < data["team2Wmin"]).astype(float))) * 2.0)).astype(float)) +
                    np.sinh(np.floor((0.367879 - (((((np.minimum( (data["team1LAverage"]),  (np.floor(data["team2WAverage"]))) == ((2.405090 < -3.0))).astype(float)) + (data["team2wins"] * np.sin(np.minimum( (data["team1Lmax"]),  (data["team2WAverage"])))))/2.0) / 2.0)))) +
                    ...
                    np.minimum( (np.cos(data["team1losses"])),  (((1.157370 < (data["team2"] * ((data["team1Lmax"] + np.round(((data["team1Wstd"] - ((((data["team1Lmax"] / 2.0) > data["team2Wmax"]).astype(float)) / 2.0)) / 2.0)))/2.0))).astype(float)))) +
                    ...
                    np.abs(np.minimum( (np.minimum( (((np.abs(data["team1Lmax"]) > ((1.695051 > (data["team1Wmedian"] + data["team1"])).astype(float))).astype(float))),  (np.cos(np.minimum( (data["team2wins"]),  ((-(np.abs(data["team1Lmax"]))))))))),  (np.cos(data["team1LAverage"])))) +
                    ...
                    (((((np.round(data["team2Lmax"]) >= ((((1.584910 <= data["team1wins"]).astype(float)) >= ((((data["team2Lmax"] <= 2.728282).astype(float)) >= data["team1Lstd"]).astype(float))).astype(float))).astype(float)) < np.minimum( (data["team2Lmax"]),  ((1.630430 + data["team1"])))).astype(float)) / 2.0) +
